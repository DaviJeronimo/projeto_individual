...
router.get("/dia/:dia/:idUsuario", function(req,res) {
    glicemiaController.buscarPorDia(req, res);
})
router.get("/tempo-real/:dia/:idUsuario", function (req,res) {
    glicemiaController.buscarTempoReal(req, res);
})
router.get("/faixas/:dia/:idUsuario", function (req, res) {
    glicemiaController.buscarFaixas(req, res);
})
